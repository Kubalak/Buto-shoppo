            ...
            <ImageBackground source={require('../assets/background.png')} style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={style.styleKuba}>
                    ...
                    <Text style={style.KubaText}>
                        ...
                        - Obsługa axiosa{'\n'}
                        - Backend w <Text style={{ ...style.KubaText, fontStyle: 'italic' }}>PHP</Text> i <Text style={{ ...style.KubaText, fontStyle: 'italic' }}>MySQL <FontAwesomeIcon icon="grin-tongue-squint" size={25} color='#EA9935' /></Text>{'\n'}
                        - Obsługa aparatu{'\n'}
    ...
    return (
        <BottomTabNavigator.Navigator>
            <BottomTabNavigator.Screen
                options={{
                    headerShown: false,
                    tabBarIcon: ({ focused }) => <FontAwesomeIcon icon="dizzy" size={18} color={focused ? '#5291FF' : '#FFA538'} /> //Należy zmienić ikonę
                }}
                name="Kuba"
                component={Kuba}
            />
            <BottomTabNavigator.Screen
                options={{
                    headerShown: false,
                    tabBarIcon: ({ focused }) => <FontAwesomeIcon icon="tired" size={18} color={focused ? '#5291FF' : '#FFA538'} /> //Należy zmienić ikonę
                }}
                name="Patryk"
                component={Patryk}
            />
